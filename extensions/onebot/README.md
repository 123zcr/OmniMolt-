...
```typescript
import { sendMsg, sendImage, sendRecord } from "@moltbot/onebot/src/api";
...
```typescript
import { extractTextFromMessage, extractMediaFromMessage } from "@moltbot/onebot/src/api";
